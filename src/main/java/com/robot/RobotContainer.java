...
import com.robot.commands.TurretCommand;
import com.robot.subsystems.BallGrabber;
import com.robot.subsystems.Turret;
import com.robot.subsystems.swervedrive.*;
...
*/
    ...
    public Command lollipopautoslow(){
      return Commands.sequence(
          autoFactory.resetOdometry("auto1slow"),
          autoFactory.trajectoryCmd("auto1slow"),
          autoFactory.trajectoryCmd("auto2slow"),
          autoFactory.trajectoryCmd("auto3slow")
      );
    }

    public Command lollipopautofast(){
      return Commands.sequence(
          autoFactory.resetOdometry("auto1fast2"),
          autoFactory.trajectoryCmd("auto1fast2"),
          autoFactory.trajectoryCmd("auto2fast2"),
          autoFactory.trajectoryCmd("auto3fast2")
      );
    }
